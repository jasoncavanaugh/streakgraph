...
*  lg:px-8 lg:py-6 
* * */
export const Modal = ({ trigger, content, open, on_open_change, modal_frame_classNames = ""}: Props) => {
  ...
  return (
    <RadixModal.Root onOpenChange={on_open_change} open={open}>
      ...
      <RadixModal.Portal>
        ...
        <RadixModal.Content className={`modal-open-animation fixed z-20 flex max-w-full rounded-lg bg-white drop-shadow-lg ${modal_frame_classNames}`}>
          {content}
        </RadixModal.Content>
      </RadixModal.Portal>
    </RadixModal.Root>
